...
class ac4Cnet_3_classes(nn.Module):
    """
    TandemMod model。
...
class ac4Cnet_eventlevel_features(nn.Module):
    """
    TandemMod model。
    ...
    """
    def __init__(self,num_classes=2,vocab_zie=5, embedding_size=4,seq_len=5):
        super(ac4Cnet_eventlevel_features,self).__init__()
...
class ac4Cnet_currentlevel_features(nn.Module):
    """
    TandemMod model。
    ...
    """
    def __init__(self,num_classes=2,vocab_zie=5, embedding_size=4,seq_len=5):
        super(ac4Cnet_signal_features,self).__init__()
